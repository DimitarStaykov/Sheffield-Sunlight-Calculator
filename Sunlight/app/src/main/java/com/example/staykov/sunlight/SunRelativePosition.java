...
public class SunRelativePosition {
    ...
    private void compute() {
        ...
        Date now = new Date();
        long offsetFromUtc = Long.valueOf(tz.getOffset(now.getTime()) / 1000);

        int julianDay1 = Time.getJulianDay(newTime,offsetFromUtc);
        final double julianDay = (double) julianDay1;
