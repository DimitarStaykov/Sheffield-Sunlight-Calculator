...
public class MapTransform2 {
    ...
    /*
    public static int[] findO2(String[][] X){
        int stringLen=X.length;
    ...
    */
    ...
    public static Triangle[] myTriangle2(String[][] A,int[] F, int[] V){
        ...
        // the integer in F points out to a row with a f in the front
        // f 6//4 1//4 5//4

        // the integer in V point to the position of the point in F-1
        // v 4.996883 0.000000 -0.663325

        // we want f -> v -> A .toPoint2
